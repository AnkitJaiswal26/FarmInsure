...
const fetchInsuranceProvider = (contractAddress, signerOrProvider) =>
  new ethers.Contract(contractAddress, InsuranceProviderABI, signerOrProvider);

const fetchInsuranceContract = (contractAddress, signerOrProvider) =>
  new ethers.Contract(contractAddress, InsuranceContractABI, signerOrProvider);
...
export const SafeInsureProvider = ({ children }) => {
  ...
  const registerUser = async (address, name, age, gender, email, mobileNo) => {
    ...
    await contract.registerUser(address, name, age, gender, email, mobileNo);
  };
  ...
  const fetchMyInsList = async (contractAdd) => {
    const contract = await connectingWithInsuranceProviderContract(contractAdd);
