...
const CompanyDashboard = () => {
	...
	const [payout1, setPayout] = useState("");
	...
	const [payFarms, setPayFarms] = useState([]);
	const {
	...
	const handlePayout = async (payoutVal, contractAdd) => {
		try {
			await payout(contractAdd, payoutVal);
		} catch (err) {
			console.log(err);
		}
	};
			...
			<div className={styles.secondContainer}>
				...
				<div className={styles.viewInsurances}>
					<div className={styles.insuranceHeadBox}>
						<h2 className={styles.insuranceHead}>
							View My Insurances
						</h2>
