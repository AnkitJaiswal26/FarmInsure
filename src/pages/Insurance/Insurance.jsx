      ...
      <div className={styles.mainContainer}>
        <div className={styles.secondContainer}>
          ...
          <div className={styles.insuranceDetails}>
            ...
            <div className={styles.insuranceInfo}>
              Duration: <span className={styles.values}>1 year</span>
            </div>
            <div className={styles.insuranceInfo}>
              Documents: <span className={styles.values}>Aadhar Card</span>
            </div>
          </div>
          <div className={styles.shadow}></div>
          <div className={styles.description}>
            To protect farmers from financial losses due to crop damage or yield
            losses caused by natural disasters, such as drought, floods, pests,
            or other unforeseen events. This type of insurance is commonly
            offered by government agencies and private insurance companies to
            provide financial support to farmers who may suffer significant
